...
const Notice = () => {
    ...
    const notice = ['name 1','name 2', 'name 3','name 4', 'name 5','name 6',
            ...
            <div className='org_rigth'>
                ...
                <div className='org_cart'>
                    ...
                    <div className='stroka' style={{marginTop: "30px"}}>
                            <div className="stroka_2"><MyButton >Очистить данные</MyButton></div>
                            <div className="stroka_2"><MyButton >Добавить</MyButton></div>
                    </div>
                </div>
            </div>
        </div>
