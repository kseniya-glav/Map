...
const EntryAdmin = () => {
    ...
    return (
        <div style={{display: "flex", justifyContent: "center", alignItems: "center", height: "calc(100vh - 160px - 40px)"}}>
            <div style={{display: "flex"}}>
                <div className='entryAdmin'>
                    <div className="name_text" style={{display: "flex", justifyContent: "center"}}>Администратор</div>
