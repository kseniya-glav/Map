                ...
                <div className='info_organization_group'>
                    ...
                    <div className="name_text mini_text type_org">
                        ...
                        {organization.type.map(type =>
                            <label style={{fontSize: "16px"}} key={type.id}><input type="checkbox" className='check_type' value={type.name}/>{type.name}</label>
                        )}
                    </div>
                    <div className="name_text mini_text">
                        ...
                        <div className='category_org'>
                            {organization.category.map(category =>
                                <label style={{fontSize: "16px"}} key={category.id}><input type="checkbox" className='check_type' value={category.name}/>{category.name}</label>
                            )}
                            <label><input type="checkbox" className='check_type'/><input type="text" style={{width: "80%" , height: "15px"}}/></label>
                        </div>
                    </div>
